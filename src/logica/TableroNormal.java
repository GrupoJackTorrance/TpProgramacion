...
public class TableroNormal  extends Tablero {
	...
	public TableroNormal(List<Jugador> jugadores) {
		...
		super.mapa[0][5] = new Casilla(objeto.getImage(),Color.YELLOW, new EfectoDarObjeto(), true);
		...
		super.mapa[0][9] = new Casilla(objeto.getImage(),Color.YELLOW, new EfectoDarObjeto(), false);
		...
		super.mapa[3][8] = new Casilla(objeto.getImage(),Color.YELLOW, new EfectoDarObjeto(), false);
		...
		super.mapa[5][0] = new Casilla(objeto.getImage(),Color.YELLOW, new EfectoDarObjeto(), true);
		...
		super.mapa[5][5] = new Casilla(objeto.getImage(),Color.YELLOW, new EfectoDarObjeto(), false);
		...
		super.mapa[7][8] = new Casilla(objeto.getImage(),Color.YELLOW, new EfectoDarObjeto(), false);
