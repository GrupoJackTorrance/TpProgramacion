...
public class TableroNormal  extends Tablero {
	...
	public TableroNormal(List<Jugador> jugadores) {
		...
		super.mapa[0][5] = new Casilla(new ImageIcon(getClass().getResource("../objeto.jpg")).getImage(),Color.YELLOW, new ObjRobarPuntos(), true);
		...
		super.mapa[0][9] = new Casilla(new ImageIcon(getClass().getResource("../objeto.jpg")).getImage(),Color.YELLOW, new ObjRobarPuntos(), false);
		...
		super.mapa[3][8] = new Casilla(new ImageIcon(getClass().getResource("../objeto.jpg")).getImage(),Color.YELLOW, new ObjDuplicarPuntaje(), false);
		...
		super.mapa[5][0] = new Casilla(new ImageIcon(getClass().getResource("../objeto.jpg")).getImage(),Color.YELLOW, new ObjDuplicarPuntaje(), true);
		...
		super.mapa[5][5] = new Casilla(new ImageIcon(getClass().getResource("../objeto.jpg")).getImage(),Color.YELLOW, new ObjDescuentaPuntos(), false);
		...
		super.mapa[7][8] = new Casilla(new ImageIcon(getClass().getResource("../objeto.jpg")).getImage(),Color.YELLOW, new ObjDescuentaPuntos(), false);
